    ...
    public class MemberActionsManager : IMemberService
    {
                ...
                switch (choose)
                {
                    case 1:
                        if (!string.IsNullOrEmpty(firstName) && !string.IsNullOrEmpty(lastName) &&
                            int.IsPositive(membershipNumber))
                        {
                        ...
                        {
                            Console.WriteLine(
                                "Üye adı, soyadı veya üyelik numarası geçerli değil!!!\nLütfen tekrar deneyin...");
                            goto repeat;
                        }
        ...
        public void Delete()
        {
            try
            {
                ...
                {
                    Console.WriteLine(
                        $"{Repository.Members[searchIndex].FirstName} {Repository.Members[searchIndex].LastName} kişisi kütüphane üyeliğinden silinecektir. Onaylıyor musunuz ?");
                    ...
                    {
                        Console.WriteLine(
                            $"{Repository.Members[searchIndex].FirstName} {Repository.Members[searchIndex].LastName} kişisin üyeliği sonlandırıldı.");
                ...
                {
                    Console.WriteLine(
                        "Aradığınız kişi kütüphane üyelerinde bulunmamaktadır.Tekrar denemek ister misiniz ?");
                    Console.WriteLine("(1) Evet \n(2) Hayır");
        ...
        public void Update()
        {
            try
            {
                ...
                if (searchIndex != -1)
                {
                    updateRepeat:
                    Console.WriteLine(
                        $"{Repository.Members[searchIndex].FirstName} {Repository.Members[searchIndex].LastName} üyesi üyeler içinde bulundu.");
                    ...
                    switch (choose)
                    {
                        ...
                        case 1:
                            ...
                            if (!string.IsNullOrEmpty(updateFirstName))
                            {
                                ...
                                Console.WriteLine(
                                    $"Üyenin adı {Repository.Members[searchIndex].FirstName} olarak güncellenmiştir.");
                            }
                            else
                            {
                        ...
                        case 2:
                            ...
                            if (!string.IsNullOrEmpty(updateLastName))
                            {
                                ...
                                Console.WriteLine(
                                    $"Üyenin soyadı {Repository.Members[searchIndex].LastName} olarak güncellenmiştir.");
                            }
                            else
                            {
                                Console.WriteLine("Üye adı geçerli değil!!!\nLütfen tekrar deneyin...");
                        ...
                        case 3:
                            ...
                            if (int.IsPositive(updateMembershipNumber))
                            {
                                ...
                                Console.WriteLine(
                                    $"Üyenin üyelik numarası {Repository.Members[searchIndex].MembershipNumber} olarak güncellenmiştir.");
                            }
                            else
                            {
                        ...
                        case 4:
                            ...
                            if (!string.IsNullOrEmpty(allUpdateFirstName) && !string.IsNullOrEmpty(allUpdateLastName) &&
                                int.IsPositive(allUpdateMembershipNumber))
                            {
                            ...
                            {
                                Console.WriteLine(
                                    "Üyelik adı, soyadı veya üyelik numarası geçerli değil!!!\nLütfen tekrar deneyin...");
                ...
                while (!isExit)
                {
                    ...
                    switch (choose)
                    {
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            sortedMemberList = Repository.Members.OrderByDescending(member => member.FirstName)
                                .ToList();
                            break;
                        default:
                            Console.WriteLine("Lütfen doğru bir seçim yapınız!!!");
