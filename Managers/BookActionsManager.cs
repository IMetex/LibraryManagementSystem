    ...
    public class BookActionsManager : IBookService
    {
                ...
                switch (choose)
                {
                    case 1:
                        if (
                            ...
                            (DateTime.TryParseExact(releaseYear, "yyyy", null,
                        ...
                        {
                            Console.WriteLine(
                                "Kitap adı,yazarı veya yayınlanma yılı geçerli değil!!!\nLütfen tekrar deneyin...");
                            goto repeat;
                        }
        ...
        public void Delete()
        {
            try
            {
                ...
                {
                    Console.WriteLine(
                        $"{Repository.Books[searchIndex].Name} kitabı kütüphaneden silinecektir. Onaylıyor musunuz ?");
                ...
                {
                    Console.WriteLine(
                        "Aradığınız kitap kütüphane kitaplarında bulunmamaktadır.Tekrar denemek ister misiniz ?");
                    Console.WriteLine("(1) Evet \n(2) Hayır");
        ...
        public void Update()
        {
            try
            {
                ...
                if (searchIndex != -1)
                {
                    updateRepeat:
                    Console.WriteLine(
                        $"{Repository.Books[searchIndex].Name} adlı kitap kütüphane kitapları içinde bulundu.");
                    ...
                    switch (choose)
                    {
                        ...
                        case 1:
                            ...
                            if (!string.IsNullOrEmpty(updateName))
                            {
                                ...
                                Console.WriteLine(
                                    $"Kitabın adı {Repository.Books[searchIndex].Name} olarak güncellenmiştir.");
                            }
                            else
                            {
                        ...
                        case 2:
                            ...
                            if (!string.IsNullOrEmpty(updateAuthor))
                            {
                                ...
                                Console.WriteLine(
                                    $"Kitabın yazarı {Repository.Books[searchIndex].Author} olarak güncellenmiştir.");
                            }
                            else
                            {
                        ...
                        case 3:
                            ...
                            if (DateTime.TryParseExact(updateReleaseYear, "yyyy", null,
                                    System.Globalization.DateTimeStyles.None, out updateDateTime))
                            {
                                Repository.Books[searchIndex].ReleaseYear = updateDateTime;
                                Console.WriteLine($"Kitabın yayınlanma yılı" +
                                                  $" {Repository.Books[searchIndex].ReleaseYear} olarak güncellenmiştir.");
                            }
                            else
                            {
                        ...
                        case 4:
                            ...
                            if (
                                ...
                                (DateTime.TryParseExact(allupdateReleaseYear, "yyyy", null,
                                    System.Globalization.DateTimeStyles.None, out allUpdateDateTime))
                            )
                            {
                ...
                {
                    Console.WriteLine(
                        "Aradığınız kitap kütüphane Kitaplerında bulunmamaktadır.Tekrar denemek ister misiniz ?");
                    Console.WriteLine("(1) Evet \n(2) Hayır");
                    int isRepeat = Convert.ToInt32(Console.ReadLine());
